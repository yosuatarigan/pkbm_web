...
import {deletedata,adddatacustomid} from '../../firebase/firebase.utils';
...
const Daftarpendaftar = ()=>{
    ...
    const  columns= [
    { title: 'Action', field: 'action' , render: rowData => <div> <button onClick={()=>new Promise(() => {
            setTimeout(() => {
              adddatacustomid('siswa',rowData.id,{...rowData})
