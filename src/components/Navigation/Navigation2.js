    ...
    return (
        ...
        <Navbar color=" bg-blue text-muted " light expand="md">
          <NavbarBrand onClick={()=> new Promise((resolve) => {
            setTimeout(() => {
              history.push(`${match.url}pkbm-hanuba3`)
          ...
          <Collapse isOpen={isOpen} navbar>
            ...
            setTimeout(() => {
              history.push(`${match.url}pkbm-hanuba3/alumni`)
              toggle();
            }, 1000);
              ...
              <NavItem>
                <NavLink onClick={()=> new Promise((resolve) => {
            setTimeout(() => {
              history.push(`${match.url}pkbm-hanuba3/tutor`)
              toggle();
            }, 1000);
              ...
              <NavItem>
                <NavLink onClick={()=> new Promise((resolve) => {
            setTimeout(() => {
              history.push(`${match.url}pkbm-hanuba3/fasilitas`)
              toggle();
            }, 1000);
              ...
              <NavItem>
                <NavLink onClick={()=> new Promise((resolve) => {
            setTimeout(() => {
              history.push(`${match.url}pkbm-hanuba3/galeri`)
              toggle();
            }, 1000);
              ...
              <NavItem>
                <NavLink onClick={()=> new Promise((resolve) => {
            setTimeout(() => {
              history.push(`${match.url}pkbm-hanuba3/pendaftaran`)
              toggle();
            }, 1000);
              ...
              <NavItem>
                <NavLink onClick={()=> new Promise((resolve) => {
            setTimeout(() => {
              history.push(`${match.url}pkbm-hanuba3/article`)
              toggle();
            }, 1000);
            ...
            setTimeout(() => {
              toggle();
              history.push(`${match.url}pkbm-hanuba3/admin`)
            ...
            setTimeout(() => {
              toggle();
              history.push(`${match.url}pkbm-hanuba3/info`)
